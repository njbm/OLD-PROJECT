...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin:15px 0px 10px 0px;">
				<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" style=" text-align:justify; font-size:24px;"> ID </div>
		<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
		<input type="text" class="form-control" name="id" placeholder="Your Name"/> </div>	
</div>
			
			
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin:15px 0px 10px 0px;">
				<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" style=" text-align:justify; font-size:24px;"> Title </div>
		<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin:15px 0px 10px 0px;">
	<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" style=" text-align:justify; font-size:24px;"> Details </div>
	<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
				<textarea class="form-control" placeholder="Details" 
				style="max-width:300px;"></textarea> </div>	
</div>
			

<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin:15px 0px 10px 0px;">
	<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" style=" text-align:justify; font-size:24px;"> Photo </div>
	<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
				<input type="file" class="btn btn-file"/> </div>	
</div>
			

			<input type="submit" class="btn btn-sucsess" value="Update" style="background:#000000; color:#FFFFFF;">
			
			<input type="submit" class="btn btn-sucsess" value="Delete" style="background:#000000; color:#FFFFFF;">
