...
if (isset($_GET["delete"])) {
  ...
  if ($query) {
   $delete_message="<span style='color:green; padding:8px; font-size:15px;'>Catagory Delete Succesfull</span>";
  }
  else{
     $delete_message="<span style='color:red; padding:8px; font-size:15px;'>Catagory Delete Unsuccesfull</span>";
  }
...
<html lang="en" data-textdirection="ltr" class="loading">
  ...
  <script type="text/javascript">
    ...
    function myfunction(){
      var r =confirm("Are you sure catagory delete from the list ?");
      if (r==true) {
        return true;
      }
      else{
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped"  id="myTable">
                        ...
                        <tbody>
                          ...
                          ?>
                            <tr>
                                <th scope="row"><span>Catagory-</span><?php echo $fetch_catagory[0]; ?></th>
                                <td><?php echo $fetch_catagory[1]; ?></td>
                                <td><?php echo $fetch_catagory[2]; ?></td>
                                <td>
                                <a href="catagory.php?edit=<?php echo $fetch_catagory[0] ?>" class="btn btn-info btn-sm mr-1"><i class="icon-check2"></i>&nbsp;Edit
                                </a> 
                                  <a href="view_catagory.php?delete=<?php  echo $fetch_catagory[0] ?>" class="btn btn-danger btn-sm " onclick="return myfunction();">
