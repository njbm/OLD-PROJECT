        ...
        <div class="header-top-left">
           ...
           <div class="dropdown top-language-wrap"> <a role="button" data-toggle="dropdown" data-target="#" class="top-language dropdown-toggle" href="#"> <img src="images/flag/e.png" alt="language"> English <span class="caret"></span> </a>
        		<ul class="dropdown-menu" role="menu">
                   <li role="presentation"><a role="menuitem" href="#"><img src="images/flag/f.png" alt="language"> Bangla </a></li>
                 </ul>
...
<div class="my-account"><a href="register.php"><span class="">Register</span></a></div>
...
<div class="login"><a href="userlogin.php"><span  class="">Log In</span></a></div>
         </div></div></div></div>
               <!-- End-Header-links -->
      </div>
   </div>
   ...
   <div class="megamenu"> <div class="megamenu-list">
    ...
    <span class="mega-single">	
     ...
     <span> <a href="shop-grid.html" class="mega-banner">
            <img src="images/menu/1.jpg" alt="Hi"></a>
	 </span>
    </div>
   </div>
</li>
...
<li class="angle-down"><a href="index.html">Pages</a>
	<ul class="sub-menu">
...
<!--Mid Body-->
	<img src="s1.jpg" style="width:100%; height:300px; ">
<!--Mid Body-->
            
            
<!--Start-footer-wrap-->
<footer class="footer-area">
<div class="footer-top-area"> <div class="container"> <div class="row">
  <div class="col-lg-3 col-md-3 col-sm-5 col-xs-12">
	...
	<div class="social-icon"> <h4>FOLLOW US ON</h4>
...
<div class="tag-area">
	...
	<h3 class="wedget-title">Related Tags</h3>
		...
		<li><a href="#">Clothing</a></li> <li><a href="#">accessories</a></li>
		<li><a href="#">fashion</a></li> <li><a href="#">top</a></li>
        </ul>
			<div class="view-all-tag">
              <ul> <li><a href="#">View All Tags</a></li> </ul>
            </div>
		</div>
	</div>
</div> <!--footer-tag-area-end-->
