  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
		...
		<li><a href="../Admin/view_about.php">About Us</a></li>
		...
		<li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" >Need Blood <span class="caret"></span></a>
          <ul class="dropdown-menu">
            <li><a href="requestblood.php">Request for Blood</a></li>
      ...
      <ul class="nav navbar-nav navbar-right">
       <li><a href="../signup/register.php"><span class="glyphicon glyphicon-user"></span> Register</a></li>
        <li><a href="../login/userlogin.php"><span class="glyphicon glyphicon-log-in"></span> Login</a></li>
...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="">
	<h1 style="padding-bottom:10px;
	font-family:Georgia, 'Times New Roman', Times, serif; color:#33FF00">ban</h1> <h1 style="padding-bottom:10px;
	font-family:Georgia, 'Times New Roman', Times, serif; color:#FF0000>la</h1> <h1 style="padding-bottom:10px;
	font-family:Georgia, 'Times New Roman', Times, serif; color:#33FF00">desh</h1>
</div>				
...
<!-- Rque Blood -->
<div class="container-fluid" style="background:#fff; color:#000033; margin-top:10px;"> <!--container-->
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="background:#FFF;
		min-height:300px; text-align:center; margin:0px;
		border-radius:10px; border:2px solid #00FF66;"> <!--full div-->
...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="">
	<h1 style="padding-bottom:10px;
	font-family:Georgia, 'Times New Roman', Times, serif;">Current Request For Blood</h1>
</div>
<?php
  ...
  ?>
<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12" style="text-align:left; background:#EBEFEF; border-radius:10px; border:2px solid #00FF66; margin:10px; width:31.5%">

	Blood Group:<?php echo $fetch[2]?> <br>
	Name:   <?php echo $fetch[0]?> <br>
	Age:  <?php echo $fetch[1]?>    Years <br>
	
	Gender:  <?php echo $fetch[3]?><br>
	Contact:   <?php echo $fetch[5]?><br>
	E-mail:   <?php echo $fetch[6]?><br>
	Address:   <?php echo $fetch[4]?><br>	
...
<footer class="w3-container w3-padding-32 w3-theme-d1 w3-center">
  ...
  <p>Powered by <a href="https://www.masud9900.blogspot.com" target="_blank">Masud</a></p>
